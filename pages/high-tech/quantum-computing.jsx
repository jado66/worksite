...
export default function QCApps() {
  return (
    <Container>
      <h1 className="text-center h3 mt-3 mb-3">Quantum Computing Applications</h1>
      <div className="px-4">
        <p>
        ...
        <div className='col-lg-6 col-12 bg-a2 rounded-3 d-flex justify-content-center mb-4' style={{minHeight:"200px"}}>
      ...
      <div className="d-flex row px-4 mb-5">
        ...
        <div className='col-lg-6 col-12 bg-a1 rounded-3 d-flex justify-content-center' style={{minHeight:"200px"}}>
          <h5 className='text-theme-inv text-center my-auto'>Picture</h5>
        </div>
      </div> 
      <hr className="bg-brand opacity-100 my-4"/>
